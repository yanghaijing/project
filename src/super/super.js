...
export default class Super extends Component{
    ...
    render(){
        ...
        return(
            <div>
                <Head gradeList={this.state.data.gradeList[this.state.index]} period={this.state.data.period}
                  Headclick={this.Headclick} src={this.state.set==1?set:back}/>
                <SuperContent gradeList={this.state.data.gradeList[this.state.index]}/>
                {
                    children
                }
    ...
    Headclick(){
        if(this.state.set==1){
            hashHistory.push("/super/index2")
        }else if(this.state.set==2){
            hashHistory.push("/super/index1")
        }
    }
    componentWillReceiveProps(props){
        if(props.location.pathname=='/super'||props.location.pathname=='/super/index1'){
            this.setState({
                set:1
            })
        }else if(props.location.pathname=='/super'||props.location.pathname=='/super/index2'){
            this.setState({
                set:2
            })
        }
